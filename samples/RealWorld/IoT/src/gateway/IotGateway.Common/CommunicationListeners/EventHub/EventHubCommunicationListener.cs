    ...
    public class EventHubCommunicationListener: ICommunicationListener
    {
        ...
        private async Task<string[]>  ResolveEventHubPartitions(string[] PartitionIds)
        {
            ...
            switch (ListenerMode)
            {
                ...
                case EventHubCommunicationListenerMode.FairDistribute:
                {
                        var servicePartitions = await getOrderedServicePartitionIds();
...
#region ctors
        public EventHubCommunicationListener(IReliableStateManager stateManager,
        ...
        public EventHubCommunicationListener(IReliableStateManager stateManager,
                                             ...
                                             string eventHubConnectionString,
                                             string eventHubConsumerGroupName,
                                             IEventDataHandler handler)  : this (stateManager, 
                                                                                 stateDictionary, 
                                                                                 eventHubName, 
                                                                                 eventHubConnectionString, 
                                                                                 eventHubConsumerGroupName, 
                                                                                 handler,
                                                                                 EventHubCommunicationListenerMode.FairDistribute, 
                                                                                 string.Empty)
        {
